...
contains
      ...
      integer idiag, jdiag, ieq, n_prof_flux
      integer &
...
11313 format(2i10, 1p8e12.4)
 ...
 1001 format(8e10.3)
  ...
  164 format(1h ,1x,4h i  ,  3x,6h R(x) , &
                 6x,6h  x   ,6x,6h btau ,6x,6hbzeta ,6x,6hre om1, &
                 6x,6hre om2,6x,6hre om3,6x,6h bmod ,6x,6h xne  , &
                 6x,6h  Te  )

 9164 format(1h ,1x,4h j  ,  3x,6h R(x) , &
                 6x,6h  y   ,6x,6h btau ,6x,6hbzeta ,6x,6hre om1, &
                 6x,6hre om2,6x,6hre om3,6x,6h bmod ,6x,6h xne  , &
                 6x,6h  Te  )
...
!
  ...
  910 format(1p8e12.4)
  920 format(2i10)
      end subroutine intplt_to_cql3d
