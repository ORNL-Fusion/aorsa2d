...
c      real wdoti1avg(nrhomax), wdoti2avg(nrhomax), xnavg(nrhomax)
...
c      real redotjeavg(nrhomax), redotj1avg(nrhomax),
c     .     redotj2avg(nrhomax), redotj3avg(nrhomax),
c     .     redotjtavg(nrhomax)
...
c      real exklog(nkpltdim, mkpltdim),
c     .     eyklog(nkpltdim, mkpltdim),
c     .     ezklog(nkpltdim, mkpltdim)

c      real exklogmin, exklogmax,
c     .     eyklogmin, eyklogmax,
c     .     ezklogmin, ezklogmax

c      complex exk(nkdim1 : nkdim2, mkdim1 : mkdim2),
c     .        eyk(nkdim1 : nkdim2, mkdim1 : mkdim2),
c     .        ezk(nkdim1 : nkdim2, mkdim1 : mkdim2)

c      real redotj1(nxmx, nymx), redotj2(nxmx, nymx), redotj3(nxmx, nymx)
c      real redotje(nxmx, nymx), redotjt(nxmx, nymx)

c      real wdoti1(nxmx, nymx), wdoti2(nxmx, nymx), wdoti3(nxmx, nymx)
c      real wdote(nxmx, nymx), wdott(nxmx, nymx)
...
c      write(53,309) nnodex, nnodey
c      write(53,310) ((theta(i, j), i = 1, nnodex), j = 1, nnodey)
