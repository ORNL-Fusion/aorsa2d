...
!      IER = PGBEG(0, 'aorsa2dSum.ps/cps', 2, 2)
...
!     --------------------------------------------------------------
      ...
      title = 'Real E alpha'
      call ezconc_sum(capr, phi3d_shift, freal, ff, nnodex, nphi3d,numb, &
                     nxmx, nphimx, nlevmax, title, titx, tity, iflag)

      title = 'Imag E alpha'
      call ezconc_sum(capr, phi3d_shift, fimag, ff, nnodex, nphi3d,numb, &
                     nxmx, nphimx, nlevmax, title, titx, tity, iflag)

      title = 'Real E dot J'
      call ezconc_sum(capr, phi3d_shift, power, ff, nnodex, nphi3d,numb, &
                     nxmx, nphimx, nlevmax, title, titx, tity, iflag)
